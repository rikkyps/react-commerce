        ...
        <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between h-20">
                ...
                <button type="button" className="relative rounded-full bg-blue-800 p-2 text-gray-100"
                    ...
                    {cartTotalItems2 > 0 && <span className='absolute -top-2 -right-2 w-6 h-6 rounded-full bg-red-600 text-white text-sm flex items-center justify-center'>{cartTotalItems2}</span>}
